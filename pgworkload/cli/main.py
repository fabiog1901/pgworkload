...
def init(
        ...
        skip_import: bool = typer.Option(
            False, '-i', '--skip-import',
            help="Don't import the CSV data files."),
        db: str = typer.Option(
            None,
            show_default=False,
            help='Override the default DB name.'),
...
@util_app.command("csv", epilog=EPILOG,  no_args_is_help=True,
...
@util_app.command("yaml", epilog=EPILOG,  no_args_is_help=True,
